...
from Workshop.Exercise_4.automate_function import FunctionInputs, automate_function
...
def fake_automation_run_data(request, test_client: SpeckleClient) -> AutomationRunData:
    ...
    automation_name = "BILT Exercise 4"
    ...
    fake_run_data = AutomationRunData(
        ...
        model_id=model_id,
        branch_name="exercise 4",
        version_id="8fe89b87d9",
